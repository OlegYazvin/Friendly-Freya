...
Source:
- OpenGameArt, "dog barking", uploaded by user `qubodup`
- URL: https://opengameart.org/content/dog-barking
- OpenGameArt, "Dog sounds", uploaded by user `justink`
...
- `barks/bark_01.wav` ... `barks/bark_06.wav` were trimmed from `dog_barking.wav`.
