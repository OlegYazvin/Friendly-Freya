...
| Claims | `godot/scripts/claim_utils.gd`, `godot/scripts/main.gd` | Ownership constants, hold-`Space` object claims, building-claim eligibility/progress/decay, territory tint, Ryah stake markers, win condition, and alien-wall weakening |
